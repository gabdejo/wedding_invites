...
export default function LocationSection({ content }: Props) {
  ...
  return (
    <section className="bg-[#e8eff7] px-6 py-24 text-center" id="location">
      <div className="mx-auto max-w-xl">
        ...
        <a
          ...
          className="inline-block border border-[#5D7B9F] px-10 py-3 text-sm uppercase tracking-[0.2em] text-[#5D7B9F] transition-colors hover:bg-[#5D7B9F] hover:text-white"
